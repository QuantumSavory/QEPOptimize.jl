...
begin
	...
	using BPGates
	using BPGates: BellMeasure, CNOTPerm, BPCircuitNoise, T1Noise, T2Noise
	using QuantumClifford: SparseGate, sCNOT, affectedqubits, BellMeasurement, Reset, sMX, sMZ, sMY, PauliNoise, noisify
end
...
begin
	...
	const config = Ref{@NamedTuple{num_simulations::Int64, number_registers::Int64, purified_pairs::Int64, code_distance::Int64, pop_size::Int64, noises::Vector{Any},circuit_noise::Union{BPGates.BPCircuitNoise,Nothing}}}()
	
	const init_config = Ref{@NamedTuple{start_ops::Int64, start_pop_size::Int64, num_simulations::Int64, number_registers::Int64, purified_pairs::Int64, code_distance::Int64, pop_size::Int64, noises::Vector{Any},circuit_noise::Union{BPGates.BPCircuitNoise,Nothing}}}()
	
	const step_config = Ref{@NamedTuple{max_ops::Int64, new_mutants::Int64, p_drop::Float64, p_mutate::Float64, p_gain::Float64, evolution_metric::Symbol, max_performance_calcs::Int64, num_simulations::Int64, number_registers::Int64, purified_pairs::Int64, code_distance::Int64, pop_size::Int64, noises::Vector{Any},circuit_noise::Union{BPGates.BPCircuitNoise,Nothing}}}()
...
begin
    circuit_noise  = if c.enable_circuit_noisification
        local_pauli = PauliNoise(c.paulix, c.pauliy, c.pauliz)
        ...
        BPGates.BPCircuitNoise(
            gate_noise = local_pauli,
